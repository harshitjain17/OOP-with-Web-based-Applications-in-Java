...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        // create customers
        CustomerLoanAccount customerA = new CustomerLoanAccount("Tony", "Stark", "111-22-3333");
        CustomerLoanAccount customerB = new CustomerLoanAccount("Gal", "Gadot", "444-55-6666");
        ...
        ArrayList<CustomerLoanAccount> customers = new ArrayList<>();
        ...
        for (CustomerLoanAccount customer:customers) {
